...
\newcommand{\jreversion}{19.0.2}
\newcommand{\gccversion}{11.4.0}
\newcommand{\gapversion}{4.13.1}
\newcommand{\spinversion}{6.1.0}
...
\input{tex/beforeyoubegin}

\tableofcontents

\input{tex/downloadandinstall}

\input{tex/workedexample}
