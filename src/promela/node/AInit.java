...
public final class AInit extends PInit
{
    ...
    public AInit(
        @SuppressWarnings("hiding") TInittok _inittok_,
    ...
    public void setInittok(TInittok node)
    {
    ...
    {
        // Replace child
        if(this._inittok_ == oldChild)
        {
            setInittok((TInittok) newChild);
            return;
        }
