...
public final class AEnabledFactor extends PFactor
{
    private TEnabled _enabled_;
    private TLParenthese _lParenthese_;
    private PExpr _expr_;
    private TRParenthese _rParenthese_;

    public AEnabledFactor()
    {
        // Constructor
    }

    public AEnabledFactor(
        @SuppressWarnings("hiding") TEnabled _enabled_,
    ...
    public Object clone()
    {
        return new AEnabledFactor(
            cloneNode(this._enabled_),
    ...
    {
        ((Analysis) sw).caseAEnabledFactor(this);
    }

    public TEnabled getEnabled()
    {
        return this._enabled_;
    }

    public void setEnabled(TEnabled node)
    {
        if(this._enabled_ != null)
        {
            this._enabled_.parent(null);
        }
    ...
    {
        // Replace child
        if(this._enabled_ == oldChild)
        {
            setEnabled((TEnabled) newChild);
            return;
        }
