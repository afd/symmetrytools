...
public final class AAtomicStmnt extends PStmnt
{
    private TAtomic _atomic_;
    ...
    public AAtomicStmnt(
        @SuppressWarnings("hiding") TAtomic _atomic_,
    ...
    {
        ((Analysis) sw).caseAAtomicStmnt(this);
    }

    public TAtomic getAtomic()
    {
        return this._atomic_;
    }

    public void setAtomic(TAtomic node)
    {
